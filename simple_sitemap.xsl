    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <link href="sites/all/modules/custom/simple_sitemap/simple_sitemap.xsl.css" type="text/css"
                      rel="stylesheet"/>
            </head>
            ...
            <body>
                ...
                <div id="footer">
                    <p>Generated by the <a href="https://drupal.org/project/simple_sitemap">Simple XML Sitemap</a>.
                    </p>
                </div>
            </body>
        </html>
